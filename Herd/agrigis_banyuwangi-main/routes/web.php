...
Route::post('save-polygon', [Mapping::class, 'poligon']);
...
Route::get('/redirect-to-mapping', [Report::class, 'redirectToMapping'])->name('gotoMapping');
...
Route::get('profile/edit', function () {
    ...
    return view('add_edit_account.profile', compact('dataUser'));
})->name('profile.edit');
